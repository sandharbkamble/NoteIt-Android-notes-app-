...
import com.example.noteit.Adapters.NotesListAdapter;
import com.example.noteit.Database.RoomDB;
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId())
        {
            case R.id.pin:
                ...
                {
                    database.mainDOA().pin(selectedNote.getID(), false);
                    Toast.makeText(MainActivity.this,"Unpinned!",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    database.mainDOA().pin(selectedNote.getID(),true);
